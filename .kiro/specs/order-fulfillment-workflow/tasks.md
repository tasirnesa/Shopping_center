...
- [ ] 1. Extend Prisma schema and run migration
  - [ ] 1.1 Add new roles and enums to schema
...
- [ ] 2. Implement the orders backend module skeleton
  - [ ] 2.1 Create module, controller, and service scaffolding
  ...
  - [ ] 2.2 Implement `StateMachineService`
  ...
  - [ ]* 2.3 Write property test for StateMachineService
  ...
  - [ ]* 2.5 Write property test for AuditService
...
- [ ] 3. Implement Sales Order creation and submission (Sales Rep)
  ...
  - [ ]* 3.2 Write property test for Sales Order DTO validation
  ...
  - [ ] 3.3 Implement order line total computation
  ...
  - [ ]* 3.4 Write property test for line total invariant
...
- [ ] 4. Implement file upload and attachment handling
  - [ ] 4.1 Implement `FileUploadService`
...
- [ ] 6. Implement Invoice Verification and Generation (Invoice Maker)
  - [ ] 6.1 Create Invoice DTOs and `InvoiceService`
...
- [ ] 9. Implement Order Cancellation and Returns
  - [ ] 9.1 Create cancellation and return DTOs
...
- [ ] 11. Implement RBAC guards and notification service
  - [ ] 11.1 Implement `@OrderOwner()` guard decorator
